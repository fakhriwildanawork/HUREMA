...
import { Plus, Search, Users, Grid, List as ListIcon, Filter, ArrowLeft, UserCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-gray-400">
          ...
          <p className="text-lg">Data akun tidak ditemukan.</p>
        </div>
      ) : viewMode === 'grid' ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="flex items-center justify-between pt-2 border-t border-gray-50">
                 ...
                 <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded uppercase ${
                   account.employee_type === 'Tetap' ? 'bg-green-50 text-green-600' : 'bg-orange-50 text-orange-600'
                 }`}>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredAccounts.map(account => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className="text-[9px] font-bold px-1.5 py-0.5 bg-gray-50 border border-gray-100 rounded uppercase text-gray-500">
                      {account.employee_type}
                    </span>
                  </td>
                </tr>
